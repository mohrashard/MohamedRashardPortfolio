...
const FrontendWeb = () => {
  ...
  useEffect(() => {
    ...
    document.title = "Frontend Website & Landing Page Development | React, Tailwind, SEO | Mohamed Rashard";
    ...
    metaDescription.setAttribute('content', 'Modern, responsive, SEO-friendly websites and landing pages for businesses, startups, and personal brands using React, Tailwind CSS, HTML, CSS, and JavaScript.');
    ...
    let scriptTag = document.getElementById('frontend-structured-data');
    if (!scriptTag) {
      scriptTag = document.createElement('script');
      scriptTag.id = 'frontend-structured-data';
