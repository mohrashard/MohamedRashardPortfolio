...
export default function TimezoneWidget() {
    ...
    return (
        <div className="relative flex flex-col gap-1.5 px-4 py-3 rounded-xl bg-white/[0.02] border border-white/[0.06] backdrop-blur-md max-w-[340px] mx-auto shadow-lg shadow-black/50 group cursor-default overflow-hidden">
            <div className="absolute inset-0 border border-[var(--primary)]/40 bg-[var(--primary)]/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-xl pointer-events-none"></div>
            ...
            <p className="relative z-10 text-zinc-400 text-xs leading-relaxed group-hover:text-zinc-300 transition-colors font-normal text-center">
