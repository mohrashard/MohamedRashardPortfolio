...
export default function TrustBar() {
    return (
        <div className="w-full bg-[#050505] border-y border-white/[0.04] py-3 relative z-20">
            ...
            <div
                className="max-w-7xl mx-auto px-6 flex justify-between items-center text-[10px] sm:text-[11px] font-bold text-zinc-400 uppercase tracking-[0.2em] gap-x-8 overflow-x-auto [&::-webkit-scrollbar]:hidden whitespace-nowrap"
                style={fontLabel}
            >
