...
export default function GlobalError({ error, reset }) {
    ...
    return (
        <html lang="en">
            <body className="bg-[#050505] text-zinc-100 min-h-screen flex items-center justify-center p-6 font-sans">
                <div className="max-w-md w-full bg-zinc-900/90 border border-zinc-800 rounded-2xl p-8 text-center backdrop-blur-xl shadow-2xl">
                    ...
                    <p className="text-sm text-zinc-400 mb-8 leading-relaxed">
                        {isChunkError
                            ? 'A new build was released for mr2labs.com. Automatically updating to fetch the latest assets...'
