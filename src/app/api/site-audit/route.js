...
The user tested website: ${targetUrl}.
Metrics:
...
Write a STRICT JSON object analyzing this SEO architecture:
{
  "verdict": (string, 2 punchy sentences critiquing metadata structure),
  "recommendation": (string, 1 technical sentence on how Mr² Labs would architect next generation SEO/GEO strategy)
}`;

        const aiData = await executeWaterfallAi(SYSTEM_PROMPT, "Analyze SEO metadata", { isJson: true });
