...
export default function AIAndML() {
  ...
  useEffect(() => {
    ...
    document.title = "AI & Machine Learning Solutions | Custom AI Development | Mohamed Rashard";
    ...
    metaDescription.setAttribute('content', 'Custom AI and Machine Learning solutions including chatbots, predictive models, NLP applications, and automation tools. Expertise in scikit-learn, XGBoost, TensorFlow, and Hugging Face.');
    ...
    const structuredData = {
      ...
      "description": "Custom AI development including chatbots, predictive models, and NLP applications",
      "provider": {
        "@type": "Person",
    ...
    let scriptTag = document.getElementById('ai-ml-structured-data');
    if (!scriptTag) {
      scriptTag = document.createElement('script');
      scriptTag.id = 'ai-ml-structured-data';
  ...
  const mailtoLink = "mailto:mohrashard@gmail.com?subject=Request%20for%20AI%20%26%20ML%20Development&body=Hello%20Mohamed,%20I%20would%20like%20to%20discuss%20a%20new%20AI%20or%20Machine%20Learning%20project.%20Please%20get%20back%20to%20me%20with%20more%20details.";
...
const benefits = [
  {
    ...
    description: "Intelligent conversational agents that understand context and provide human-like interactions for customer service and support."
  },
  {
    icon: <Brain className="webapp__benefit-icon" />,
    title: "Natural Language Processing", 
    description: "Advanced text analysis, sentiment detection, and language understanding for processing unstructured data."
  },
  {
    icon: <BarChart className="webapp__benefit-icon" />,
    title: "Predictive Analytics & Models",
    description: "Machine learning models that forecast trends, identify patterns, and make data-driven predictions for business decisions."
  },
  {
    icon: <Cpu className="webapp__benefit-icon" />,
    title: "Process Automation Solutions",
    description: "AI-powered automation tools that streamline workflows, reduce manual tasks, and increase operational efficiency."
  },
  {
    icon: <Key className="webapp__benefit-icon" />,
    title: "AI Integrations with API Keys",
    description: "Securely connect with AI platforms like OpenAI, Gemini, and more using API keys to power advanced features in your apps."
  },
  {
    icon: <SmartphoneIcon className="webapp__benefit-icon" />,
    title: "Mobile App Development",
    description: "Build responsive, high-performance mobile applications for iOS and Android, leveraging AI and modern frameworks."
  },
  {
    icon: <LaptopIcon className="webapp__benefit-icon" />,
    title: "Web App & Software Development",
    description: "Custom web applications and software solutions, integrating AI functionalities, real-time features, and scalable architectures."
  }
];
...
const techStack = [
  ...
  {
    name: "scikit-learn", 
    description: "Machine learning library for Python with simple tools for data mining",
    icon: <Layers className="webapp__tech-icon" />
  },
  {
    name: "XGBoost", 
    description: "Optimized distributed gradient boosting library designed for efficiency", 
    icon: <Database className="webapp__tech-icon" />
  },
  {
    name: "Hugging Face",
    description: "Advanced natural language processing with state-of-the-art transformers",
    icon: <Monitor className="webapp__tech-icon" />
  },
  {
    name: "OpenAI",
    description: "AI models and APIs for text, image, and code generation, enabling intelligent applications",
    icon: <Cpu className="webapp__tech-icon" />
  },
  {
    name: "Gemini AI",
    description: "Next-generation AI models for conversational AI, reasoning, and multimodal tasks",
    icon: <Brain className="webapp__tech-icon" />
  },
  {
    name: "PyTorch",
    description: "Deep learning framework for building neural networks with flexibility and speed",
    icon: <Code className="webapp__tech-icon" />
  },
  {
    name: "LangChain",
    description: "Framework for building AI applications with LLMs, pipelines, and data integration",
    icon: <Layers className="webapp__tech-icon" />
  },
  {
    name: "Random Forest",
  ...
  },
  {
    ...
    description: "Supervised learning algorithm for classification and regression by finding the optimal hyperplane",
    icon: < Activity className="webapp__tech-icon" />
  },
  {
    name: "Neural Networks",
    description: "Computational models inspired by the human brain for deep learning and pattern recognition",
    icon: <Cpu className="webapp__tech-icon" />
  }
];
...
const caseStudies = [
  ...
  const navSections = [
    { label: 'Solutions', icon: <Zap className="webapp__nav-icon-small" />, ref: benefitsRef },
    { label: 'Technologies', icon: <Layers className="webapp__nav-icon-small" />, ref: techRef },
    { label: 'Projects', icon: <ExternalLink className="webapp__nav-icon-small" />, ref: casesRef },
    { label: 'Expertise', icon: <Shield className="webapp__nav-icon-small" />, ref: contentRef },
    { label: 'Contact', icon: <Send className="webapp__nav-icon-small" />, ref: ctaRef }
  ];
      ...
      <section ref={contentRef} className="webapp__section webapp__content-section">
        <div className="webapp__section-content">
          ...
          <div className="webapp__content-text webapp__animate-on-scroll">
            <p>
              Artificial Intelligence and Machine Learning are transforming industries by enabling 
              intelligent automation, predictive insights, and enhanced user experiences. With 
              expertise in developing custom AI solutions, I help businesses leverage these 
              technologies to solve complex problems, optimize operations, and create innovative 
              products.
            </p>
            <p>
              From developing sophisticated NLP applications that understand and process human language 
              to building predictive models that forecast trends and identify patterns, my approach 
              combines cutting-edge algorithms with practical business understanding. The result is 
              AI solutions that are not just technologically advanced but also deliver measurable 
              business value.
            </p>
          </div>
          ...
          <div className="webapp__features-grid webapp__animate-on-scroll">
            <div className="webapp__feature-item">
              ...
              <span className="webapp__feature-text">Custom AI Development</span>
            </div>
            <div className="webapp__feature-item">
              <CheckCircle className="webapp__feature-icon" />
              <span className="webapp__feature-text">Data-driven Insights</span>
            </div>
            <div className="webapp__feature-item">
              <CheckCircle className="webapp__feature-icon" />
            ...
            <div className="webapp__feature-item">
              <CheckCircle className="webapp__feature-icon" />
              <span className="webapp__feature-text">Predictive Analytics</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section ref={ctaRef} className="webapp__cta-section">
        <div className="webapp__cta-content">
          ...
          <p className="webapp__cta-subtitle webapp__animate-on-scroll">
            Let's discuss how AI and machine learning can transform your operations and create new opportunities.
          </p>
